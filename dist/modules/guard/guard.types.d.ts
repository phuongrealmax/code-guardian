export { ValidationResult, ValidationIssue, CodeLocation, GuardModuleConfig, GuardRules, CustomRule, } from '../../core/types.js';
/**
...
export type RuleCategory = 'testing' | 'security' | 'quality' | 'convention' | 'performance' | 'custom';
/**
