 ...
 */
export function createLatentTools(service) {
    return [
        // ═══════════════════════════════════════════════════════════════
        //                      CONTEXT MANAGEMENT
        // ═══════════════════════════════════════════════════════════════
 ...
 */
export async function handleLatentTool(service, toolName, args) {
    switch (toolName) {
        // Context Management
        ...
        case 'latent_complete_task': {
            await service.completeTask(args.taskId, args.summary);
            return {
                success: true,
                taskId: args.taskId,
        ...
        case 'latent_delete_context': {
            const deleted = await service.deleteContext(args.taskId);
            return {
                success: deleted,
                taskId: args.taskId,
                message: deleted
...
//# sourceMappingURL=latent.tools.js.map