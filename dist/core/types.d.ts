...
export type ProjectType = 'typescript-react' | 'typescript-node' | 'javascript' | 'python' | 'other';
...
export type MemoryType = 'decision' | 'fact' | 'code_pattern' | 'error' | 'note' | 'convention' | 'architecture';
...
export type TaskStatus = 'pending' | 'in_progress' | 'paused' | 'blocked' | 'completed' | 'failed' | 'cancelled';
...
export type DocumentType = 'readme' | 'spec' | 'api' | 'guide' | 'changelog' | 'architecture' | 'config' | 'other';
...
export type CheckpointReason = 'auto_threshold' | 'manual' | 'task_complete' | 'session_end' | 'error_recovery' | 'before_risky_operation';
