...
// ═══════════════════════════════════════════════════════════════
//                      LATENT RESPONSE FORMAT
// ═══════════════════════════════════════════════════════════════

/**
 * Action types for Latent Chain
 */
export type LatentActionType =
  | 'edit_file'
  | 'create_file'
  | 'delete_file'
  | 'apply_patch'
...
export interface LatentEvents {
  'latent:context:created': { taskId: string; context: AgentLatentContext };
  'latent:context:updated': { taskId: string; delta: ContextDelta; version: number };
  'latent:phase:transition': { taskId: string; from: LatentPhase; to: LatentPhase };
  'latent:patch:applied': { taskId: string; target: string; success: boolean };
  'latent:task:completed': { taskId: string; summary: string };
  'latent:validation:failed': { taskId: string; errors: LatentValidationError[] };
}
